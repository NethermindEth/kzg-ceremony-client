...

{
    public static class blst
    {
        ...
        static void BlstLib() => AssemblyLoadContext.Default.ResolvingUnmanagedDll += (assembly, path) => NativeLibrary.Load($"runtimes/{(
        ...
        [DllImport("blstlib", CallingConvention = CallingConvention.Cdecl)]
        static extern
