...
public class Participant
{
    ...
    public async Task<ContributionReceipt?> Contribute(int pollingInterval, string sessionToken)
    {
        ...
        while (true)
        {
            contributionBatch = await _coordinator.TryContribute(sessionToken);
